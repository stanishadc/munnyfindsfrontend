...
export default function BusinessDetails(props) {
    ...
    const applicationAPI = () => {
        return {
            fetchBusinessDetails: () => axios.get('https://localhost:44368/api/business/GetByURL/' + props.match.params["businessurl"]),
            fetchBusinessImages: (id) => axios.get('https://localhost:44368/api/BusinessImages/GetByBusiness/' + id),
            fetchServices: (id) => axios.get('https://localhost:44368/api/ServicePrice/GetByBusinessId/' + id),
            fetchReviews: (id) => axios.get('https://localhost:44368/api/appointments/GetByBusinessId/' + id),
        }
    }
