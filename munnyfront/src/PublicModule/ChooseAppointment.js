...
export default function ChooseAppointment(props) {
    ...
    async function fetchOpeningHours() {
        const response = await fetch('https://localhost:44313/api/BusinessAvailability/GetByBusinessId/' + values.businessId);
    ...
    async function fetchAppointment() {
        const response = await fetch('https://localhost:44313/api/appointments/CheckOffline/' + values.businessId);
        const json = await response.json();
        //console.log(json)
