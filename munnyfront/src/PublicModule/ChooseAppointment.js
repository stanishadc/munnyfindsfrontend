...
export default function ChooseAppointment(props) {
    ...
    async function fetchOpeningHours() {
        const response = await fetch("http://165.22.216.222/api/BusinessAvailability/GetByBusinessId/" + values.businessId);
        const json = await response.json();
        //setValues(json);
    }
    async function fetchBusinessEmployee() {
        const response = await fetch("http://165.22.216.222/api/BusinessEmployee/GetById/" + values.businessId);
        const json = await response.json();
        setBusinessEmployeeList(json)
        fetchBusinessEmployee()
        }
    async function fetchOffline() {
        const response = await fetch("http://165.22.216.222/api/BusinessOffline/GetById/" + values.businessId);
        const json = await response.json();
        {
            json && json.map(d =>
    ...
    async function fetchAppointment() {
        const response = await fetch("http://165.22.216.222/api/appointments/CheckOffline/" + values.businessId);
        const json = await response.json();
        //console.log(json)
