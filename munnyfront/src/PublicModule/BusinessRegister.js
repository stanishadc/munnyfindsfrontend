                ...
                <div className="container">
                    <div id="businessRegister" className="bg-light shadow-md rounded mx-auto p-4">
                        <ul className="nav nav-tabs nav-justified" role="tablist">
                            <li className="nav-item"> <a id="signup-page-tab" className="nav-link text-6">Please Enter Business Details</a>&nbsp;<Link className="mx-2" style={{ textAlign: 'right' }} onClick={toggleBPopup}>Already Registered? Login</Link></li>
                        </ul>
