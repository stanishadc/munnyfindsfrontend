                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-7 col-lg-6">
                            <h2 className="text-9 font-weight-600 my-4">Download Our MunnyFinds<br className="d-none d-lg-inline-block" />
            Mobile App Now</h2>
                            <p className="lead">Download our app for the fastest, most convenient way to book service</p>
                            <ul>
                                <li>Salons</li>
                                <li>Gyms</li>
                                <li>Yoga</li>
